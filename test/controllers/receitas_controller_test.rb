...
class ReceitasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create receita" do
    assert_difference("Receita.count") do
      post receitas_url, params: { receita: { descricao: @receita.descricao, nome: @receita.nome, valor: @receita.valor } }
    end
  ...
  test "should update receita" do
    patch receita_url(@receita), params: { receita: { descricao: @receita.descricao, nome: @receita.nome, valor: @receita.valor } }
